...
<body style="padding-top: 70px">
    <nav class="navbar fixed-top navbar-expand-lg navbar-dark bg-dark"> <a class="navbar-brand" href="#"><img
                src="Images/ลุงหนวด.png" width="48" height="46" alt="" />KFC</a>
        <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent1"
            aria-controls="navbarSupportedContent1" aria-expanded="false" aria-label="Toggle navigation"> <span
                class="navbar-toggler-icon"></span> </button>
        <div class="collapse navbar-collapse" id="navbarSupportedContent1">
            <ul class="navbar-nav mr-auto">
                <li class="nav-item active"> <a class="nav-link" href="Index.php">หน้าแรก<span
    ...
    <div id="carouselExampleIndicators1" class="carousel slide" data-ride="carousel" style="background-color: grey">
        ...
        <div class="carousel-inner" role="listbox">
            <div class="carousel-item active"> <img src="Images/Ban1.jpg" alt="First slide"
                    class="d-block mx-auto w-100"> </div>
            <div class="carousel-item"> <img src="Images/Ban2.jpg" alt="Second slide" class="d-block mx-auto w-100">
            </div>
            <div class="carousel-item"> <img src="Images/Ban3.jpg" alt="Third slide" class="d-block mx-auto w-100">
            </div>
        </div>
            ...
            <div class="col-md-4 pb-1 pb-md-0">
                <div class="card"> <img class="card-img-top" src="Images/p1.png" alt="Card image cap">
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary">29 บาท</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 pb-1 pb-md-0">
                <div class="card"> <img class="card-img-top" src="Images/p2.png" alt="Card image cap">
                    <div class="card-body">
                        ...
                        <p class="card-text">ไก่ทอด 6 ชิ้น<br>
                            ...
                            มันบด (ปกติ) 1 ที่</p>
                        <a href="#" class="btn btn-primary">299 บาท</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 pb-1 pb-md-0">
                <div class="card"> <img class="card-img-top" src="Images/p3.png" alt="Card image cap">
                    <div class="card-body">
                        ...
                        <p class="card-text">ไก่ทอด 4 ชิ้น<br>
                            ...
                            เป๊ปซี่ 2 ที่*</p>
                        <a href="#" class="btn btn-primary">239 บาท</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="col-md-4 pb-1 pb-md-0">
                <div class="card"> <img class="card-img-top" src="Images/p4.png" alt="Card image cap">
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary">119 บาท</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 pb-1 pb-md-0">
                <div class="card"> <img class="card-img-top" src="Images/p5.png" alt="Card image cap">
                    <div class="card-body">
                        ...
                        <p class="card-text">1 ข้าวแพลนต์เบส
                            ...
                            เป๊ปซี่ 1 ที่*</p>
                        <a href="#" class="btn btn-primary">179 บาท</a>
                    </div>
                </div>
            </div>
            <div class="col-md-4 pb-1 pb-md-0">
                <div class="card"> <img class="card-img-top" src="Images/p6.png" alt="Card image cap">
                    <div class="card-body">
                        ...
                        <a href="#" class="btn btn-primary">75 บาท</a>
                    </div>
                </div>
            </div>
        </div>
        <img src="Images/banner.jpg" alt="Placeholder image" class="img-fluid w-100">
    </div>
