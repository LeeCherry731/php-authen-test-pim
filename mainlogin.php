  ...
  <body>
    <div class="container-fluid">
	    <ul id="clothingnav1" class="nav nav-tabs" role="tablist">
	      <li class="nav-item"> <a class="nav-link active" href="#home1" id="hometab1" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">เข้าสู่ระบบ</a> </li>
	      <li class="nav-item"> <a class="nav-link" href="#paneTwo1" role="tab" id="hatstab1" data-toggle="tab" aria-controls="hats">ลงทะเบียน</a> </li>
	      <!-- Dropdown -->
      </ul>
	    <!-- Content Panel -->
	    <div id="clothingnavcontent1" class="tab-content">
	      <div role="tabpanel" class="tab-pane fade show active" id="home1" aria-labelledby="hometab1">
	        <form action="checklogin.php" metohd="post">
	      ...
	      <div role="tabpanel" class="tab-pane fade" id="paneTwo1" aria-labelledby="hatstab1">
	        <form action="checkregister.php" method="get">
	          ...
	          <div class="form-group">
	            ...
	            <input type="text" class="form-control" id="exampleInputPassword4" placeholder="กรอกนามสกุล" name="fname">
              </div>
	          <div class="form-group">
	            <label for="exampleInputPassword5">เบอร์โทร</label>
	            <input type="text" class="form-control" id="exampleInputPassword5" placeholder="กรอกเบอร์โทร" name="fname">
              </div>
